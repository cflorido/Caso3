...
public class Cliente {
    public static void main(String[] args) throws Exception {
        ...
        // 11a. Generar par de llaves DH usando G, P
        ...
        // 16. Recibir IP servidor + puerto cifrado + HMAC
        ...
        System.out.println("IP y puerto del servidor: " + ipServidor);

        // 18. Esperar "OK"
        String finalRespuesta = in.readUTF();
        System.out.println("Resultado final: " + finalRespuesta);
